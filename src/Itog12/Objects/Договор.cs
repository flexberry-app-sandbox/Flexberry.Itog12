...
namespace IIS.Itog12
{
    ...
    [View("ДоговорE", new string[] {
            ...
            "ДирОтдПоРабСКл as \'Директор отдела по работе с клиентами\'",
            "ДирОтдПоРабСКл.Имя as \'Имя\'",
            "ДирОтдПоРабСКл.Отчество as \'Отчество\'",
            "Клиент as \'Фамилия\'",
            "Клиент.Имя as \'Имя\'",
            "Клиент.Отчество as \'Отчество\'"})]
    [MasterViewDefineAttribute("ДоговорE", "Длительность", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Длительность")]
    ...
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog12.Статус fСтатус;
        
        private IIS.Itog12.ТипДоговора fТип;
        
        private int fСтоимость;
        
        private IIS.Itog12.Длительность fДлительность;
        
        private IIS.Itog12.Клиент fКлиент;
        
        private IIS.Itog12.ДирОтдПоРабСКл fДирОтдПоРабСКл;
        ...
        public virtual IIS.Itog12.Статус Статус
        {
            get
            {
                ...
                IIS.Itog12.Статус result = this.fСтатус;
        ...
        public virtual IIS.Itog12.ТипДоговора Тип
        {
            get
            {
                ...
                IIS.Itog12.ТипДоговора result = this.fТип;
        ...
        [PropertyStorage(new string[] {
                "ДирОтдПоРабСКл"})]
        [NotNull()]
        public virtual IIS.Itog12.ДирОтдПоРабСКл ДирОтдПоРабСКл
        {
            get
            {
                ...
                IIS.Itog12.ДирОтдПоРабСКл result = this.fДирОтдПоРабСКл;
        ...
        [PropertyStorage(new string[] {
                "Длительность"})]
        [NotNull()]
        public virtual IIS.Itog12.Длительность Длительность
        {
            get
            {
                ...
                IIS.Itog12.Длительность result = this.fДлительность;
        ...
        [PropertyStorage(new string[] {
                "Клиент"})]
        [NotNull()]
        public virtual IIS.Itog12.Клиент Клиент
        {
            get
            {
                ...
                IIS.Itog12.Клиент result = this.fКлиент;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.Itog12.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.Itog12.Договор));
                }
            }
        }
    }
