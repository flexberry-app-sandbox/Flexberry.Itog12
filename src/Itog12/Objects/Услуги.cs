...
namespace IIS.Itog12
{
    ...
    [MasterViewDefineAttribute("УслугиE", "ЗатрВремя", ICSSoft.STORMNET.LookupTypeEnum.Standard, "", "Затраченное время")]
    ...
    public class Услуги : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Itog12.Услуга fНаименование;
        
        private IIS.Itog12.ЗатрВремя fЗатрВремя;
        ...
        public virtual IIS.Itog12.Услуга Наименование
        {
            get
            {
                ...
                IIS.Itog12.Услуга result = this.fНаименование;
        ...
        [PropertyStorage(new string[] {
                "ЗатрВремя"})]
        [NotNull()]
        public virtual IIS.Itog12.ЗатрВремя ЗатрВремя
        {
            get
            {
                ...
                IIS.Itog12.ЗатрВремя result = this.fЗатрВремя;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугE", typeof(IIS.Itog12.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ПереченьУслугL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ПереченьУслугL", typeof(IIS.Itog12.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиE", typeof(IIS.Itog12.Услуги));
                }
            }
            ...
            public static ICSSoft.STORMNET.View УслугиL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("УслугиL", typeof(IIS.Itog12.Услуги));
                }
            }
        }
    }
